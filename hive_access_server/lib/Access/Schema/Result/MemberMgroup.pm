use utf8;
package Access::Schema::Result::MemberMgroup;
...
Related object: L<Access::Schema::Result::Member>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:0TbULrxFEmVbO20oz7rnxA

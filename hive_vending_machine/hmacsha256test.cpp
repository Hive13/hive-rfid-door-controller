...
void hmac_test() {
  ...
  Serial.print("Result:");
  hmac_sha256_init(hmacKey1, 20);
  sha256_print("Hi There");
  printHash(hmac_sha256_result());
  Serial.println();
  
  Serial.println("Test: RFC4231 4.3");
  Serial.println("Expect:5bdcc146bf60754e6a042426089575c75a003f089d2739839dec58b964ec3843");
  Serial.print("Result:");
  hmac_sha256_init((uint8_t*)"Jefe",4);
  sha256_print("what do ya want for nothing?");
  printHash(hmac_sha256_result());
  Serial.println();
  ...
  Serial.print("Result:");
  hmac_sha256_init(hmacKey3,20);
  for (a=0; a<50; a++) sha256_write(0xdd);
  printHash(hmac_sha256_result());
  Serial.println();
  ...
  Serial.print("Result:");
  hmac_sha256_init(hmacKey2,25);
  for (a=0; a<50; a++) sha256_write(0xcd);
  printHash(hmac_sha256_result());
  Serial.println();
  ...
  Serial.print("Result:");
  hmac_sha256_init(hmacKey4,20);
  sha256_print("Test With Truncation");
  printHash(hmac_sha256_result());
  Serial.println();
  ...
  Serial.print("Result:");
  hmac_sha256_init(hmacKey5,131);
  sha256_print("Test Using Larger Than Block-Size Key - Hash Key First");
  printHash(hmac_sha256_result());
  Serial.println();
  ...
  Serial.print("Result:");
  hmac_sha256_init(hmacKey5,131);
  sha256_print("This is a test using a larger than block-size key and a larger than "
